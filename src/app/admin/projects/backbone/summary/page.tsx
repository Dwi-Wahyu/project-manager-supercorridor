...
export default async function BackboneProjectSummaryPage() {
  const projectsSummery = await getProjectsSummary("backbone");
  ...
  return (
    <div className="flex flex-col gap-y-5">
      ...
      <IdlePortTable category="backbone" />

      <OccupancyPortTable category="backbone" />

      <ProjectBarChart category="backbone" />
    </div>
  );
}
